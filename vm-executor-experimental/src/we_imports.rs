...
#[rustfmt::skip]
fn wasmer_import_get_sc_address(env: FunctionEnvMut<VMHooksWrapper>, result_offset: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_sc_address(convert_mem_ptr(result_offset)))
}

#[rustfmt::skip]
fn wasmer_import_get_owner_address(env: FunctionEnvMut<VMHooksWrapper>, result_offset: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_owner_address(convert_mem_ptr(result_offset)))
}

#[rustfmt::skip]
fn wasmer_import_get_shard_of_address(env: FunctionEnvMut<VMHooksWrapper>, address_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_shard_of_address(convert_mem_ptr(address_offset)))
}

#[rustfmt::skip]
fn wasmer_import_is_smart_contract(env: FunctionEnvMut<VMHooksWrapper>, address_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.is_smart_contract(convert_mem_ptr(address_offset)))
}

#[rustfmt::skip]
fn wasmer_import_signal_error(env: FunctionEnvMut<VMHooksWrapper>, message_offset: i32, message_length: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.signal_error(convert_mem_ptr(message_offset), convert_mem_length(message_length)))
}

#[rustfmt::skip]
fn wasmer_import_get_external_balance(env: FunctionEnvMut<VMHooksWrapper>, address_offset: i32, result_offset: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_external_balance(convert_mem_ptr(address_offset), convert_mem_ptr(result_offset)))
}

#[rustfmt::skip]
fn wasmer_import_get_block_hash(env: FunctionEnvMut<VMHooksWrapper>, nonce: i64, result_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_block_hash(nonce, convert_mem_ptr(result_offset)))
}

#[rustfmt::skip]
fn wasmer_import_get_esdt_balance(env: FunctionEnvMut<VMHooksWrapper>, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64, result_offset: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_get_esdt_nft_name_length(env: FunctionEnvMut<VMHooksWrapper>, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_get_esdt_nft_attribute_length(env: FunctionEnvMut<VMHooksWrapper>, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_get_esdt_nft_uri_length(env: FunctionEnvMut<VMHooksWrapper>, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_get_esdt_token_data(env: FunctionEnvMut<VMHooksWrapper>, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64, value_handle: i32, properties_offset: i32, hash_offset: i32, name_offset: i32, attributes_offset: i32, creator_offset: i32, royalties_handle: i32, uris_offset: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_get_esdt_local_roles(env: FunctionEnvMut<VMHooksWrapper>, token_id_handle: i32) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_esdt_local_roles(token_id_handle))
}

#[rustfmt::skip]
fn wasmer_import_validate_token_identifier(env: FunctionEnvMut<VMHooksWrapper>, token_id_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.validate_token_identifier(token_id_handle))
}

#[rustfmt::skip]
fn wasmer_import_transfer_value(env: FunctionEnvMut<VMHooksWrapper>, dest_offset: i32, value_offset: i32, data_offset: i32, length: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_transfer_value_execute(env: FunctionEnvMut<VMHooksWrapper>, dest_offset: i32, value_offset: i32, gas_limit: i64, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_transfer_esdt_execute(env: FunctionEnvMut<VMHooksWrapper>, dest_offset: i32, token_id_offset: i32, token_id_len: i32, value_offset: i32, gas_limit: i64, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_transfer_esdt_nft_execute(env: FunctionEnvMut<VMHooksWrapper>, dest_offset: i32, token_id_offset: i32, token_id_len: i32, value_offset: i32, nonce: i64, gas_limit: i64, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_multi_transfer_esdt_nft_execute(env: FunctionEnvMut<VMHooksWrapper>, dest_offset: i32, num_token_transfers: i32, token_transfers_args_length_offset: i32, token_transfer_data_offset: i32, gas_limit: i64, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_create_async_call(env: FunctionEnvMut<VMHooksWrapper>, dest_offset: i32, value_offset: i32, data_offset: i32, data_length: i32, success_offset: i32, success_length: i32, error_offset: i32, error_length: i32, gas: i64, extra_gas_for_callback: i64) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_upgrade_contract(env: FunctionEnvMut<VMHooksWrapper>, dest_offset: i32, gas_limit: i64, value_offset: i32, code_offset: i32, code_metadata_offset: i32, length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> Result<(), VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_upgrade_from_source_contract(env: FunctionEnvMut<VMHooksWrapper>, dest_offset: i32, gas_limit: i64, value_offset: i32, source_contract_address_offset: i32, code_metadata_offset: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> Result<(), VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_delete_contract(env: FunctionEnvMut<VMHooksWrapper>, dest_offset: i32, gas_limit: i64, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> Result<(), VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_async_call(env: FunctionEnvMut<VMHooksWrapper>, dest_offset: i32, value_offset: i32, data_offset: i32, length: i32) -> Result<(), VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_get_argument_length(env: FunctionEnvMut<VMHooksWrapper>, id: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_argument_length(id))
}

#[rustfmt::skip]
fn wasmer_import_get_argument(env: FunctionEnvMut<VMHooksWrapper>, id: i32, arg_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_argument(id, convert_mem_ptr(arg_offset)))
}

#[rustfmt::skip]
fn wasmer_import_get_function(env: FunctionEnvMut<VMHooksWrapper>, function_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_function(convert_mem_ptr(function_offset)))
}

#[rustfmt::skip]
fn wasmer_import_get_num_arguments(env: FunctionEnvMut<VMHooksWrapper>) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_num_arguments())
}

#[rustfmt::skip]
fn wasmer_import_storage_store(env: FunctionEnvMut<VMHooksWrapper>, key_offset: i32, key_length: i32, data_offset: i32, data_length: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_storage_load_length(env: FunctionEnvMut<VMHooksWrapper>, key_offset: i32, key_length: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.storage_load_length(convert_mem_ptr(key_offset), convert_mem_length(key_length)))
}

#[rustfmt::skip]
fn wasmer_import_storage_load_from_address(env: FunctionEnvMut<VMHooksWrapper>, address_offset: i32, key_offset: i32, key_length: i32, data_offset: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_storage_load(env: FunctionEnvMut<VMHooksWrapper>, key_offset: i32, key_length: i32, data_offset: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_set_storage_lock(env: FunctionEnvMut<VMHooksWrapper>, key_offset: i32, key_length: i32, lock_timestamp: i64) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.set_storage_lock(convert_mem_ptr(key_offset), convert_mem_length(key_length), lock_timestamp))
}

#[rustfmt::skip]
fn wasmer_import_get_storage_lock(env: FunctionEnvMut<VMHooksWrapper>, key_offset: i32, key_length: i32) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_storage_lock(convert_mem_ptr(key_offset), convert_mem_length(key_length)))
}

#[rustfmt::skip]
fn wasmer_import_is_storage_locked(env: FunctionEnvMut<VMHooksWrapper>, key_offset: i32, key_length: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.is_storage_locked(convert_mem_ptr(key_offset), convert_mem_length(key_length)))
}

#[rustfmt::skip]
fn wasmer_import_clear_storage_lock(env: FunctionEnvMut<VMHooksWrapper>, key_offset: i32, key_length: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.clear_storage_lock(convert_mem_ptr(key_offset), convert_mem_length(key_length)))
}

#[rustfmt::skip]
fn wasmer_import_get_caller(env: FunctionEnvMut<VMHooksWrapper>, result_offset: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_caller(convert_mem_ptr(result_offset)))
}

#[rustfmt::skip]
fn wasmer_import_check_no_payment(env: FunctionEnvMut<VMHooksWrapper>) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.check_no_payment())
}

#[rustfmt::skip]
fn wasmer_import_get_call_value(env: FunctionEnvMut<VMHooksWrapper>, result_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_call_value(convert_mem_ptr(result_offset)))
}

#[rustfmt::skip]
fn wasmer_import_get_esdt_value(env: FunctionEnvMut<VMHooksWrapper>, result_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_esdt_value(convert_mem_ptr(result_offset)))
}

#[rustfmt::skip]
fn wasmer_import_get_esdt_value_by_index(env: FunctionEnvMut<VMHooksWrapper>, result_offset: i32, index: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_esdt_value_by_index(convert_mem_ptr(result_offset), index))
}

#[rustfmt::skip]
fn wasmer_import_get_esdt_token_name(env: FunctionEnvMut<VMHooksWrapper>, result_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_esdt_token_name(convert_mem_ptr(result_offset)))
}

#[rustfmt::skip]
fn wasmer_import_get_esdt_token_name_by_index(env: FunctionEnvMut<VMHooksWrapper>, result_offset: i32, index: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_esdt_token_name_by_index(convert_mem_ptr(result_offset), index))
}

#[rustfmt::skip]
fn wasmer_import_get_esdt_token_nonce(env: FunctionEnvMut<VMHooksWrapper>) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_esdt_token_nonce())
}

#[rustfmt::skip]
fn wasmer_import_get_esdt_token_nonce_by_index(env: FunctionEnvMut<VMHooksWrapper>, index: i32) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_esdt_token_nonce_by_index(index))
}

#[rustfmt::skip]
fn wasmer_import_get_current_esdt_nft_nonce(env: FunctionEnvMut<VMHooksWrapper>, address_offset: i32, token_id_offset: i32, token_id_len: i32) -> Result<i64, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_get_esdt_token_type(env: FunctionEnvMut<VMHooksWrapper>) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_esdt_token_type())
}

#[rustfmt::skip]
fn wasmer_import_get_esdt_token_type_by_index(env: FunctionEnvMut<VMHooksWrapper>, index: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_esdt_token_type_by_index(index))
}

#[rustfmt::skip]
fn wasmer_import_get_num_esdt_transfers(env: FunctionEnvMut<VMHooksWrapper>) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_num_esdt_transfers())
}

#[rustfmt::skip]
fn wasmer_import_get_call_value_token_name(env: FunctionEnvMut<VMHooksWrapper>, call_value_offset: i32, token_name_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_call_value_token_name(convert_mem_ptr(call_value_offset), convert_mem_ptr(token_name_offset)))
}

#[rustfmt::skip]
fn wasmer_import_get_call_value_token_name_by_index(env: FunctionEnvMut<VMHooksWrapper>, call_value_offset: i32, token_name_offset: i32, index: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_is_reserved_function_name(env: FunctionEnvMut<VMHooksWrapper>, name_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.is_reserved_function_name(name_handle))
}

#[rustfmt::skip]
fn wasmer_import_write_log(env: FunctionEnvMut<VMHooksWrapper>, data_pointer: i32, data_length: i32, topic_ptr: i32, num_topics: i32) -> Result<(), VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_write_event_log(env: FunctionEnvMut<VMHooksWrapper>, num_topics: i32, topic_lengths_offset: i32, topic_offset: i32, data_offset: i32, data_length: i32) -> Result<(), VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_get_block_timestamp(env: FunctionEnvMut<VMHooksWrapper>) -> Result<i64, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_get_block_round(env: FunctionEnvMut<VMHooksWrapper>) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_block_round())
}

#[rustfmt::skip]
fn wasmer_import_get_block_epoch(env: FunctionEnvMut<VMHooksWrapper>) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_block_epoch())
}

#[rustfmt::skip]
fn wasmer_import_get_block_random_seed(env: FunctionEnvMut<VMHooksWrapper>, pointer: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_block_random_seed(convert_mem_ptr(pointer)))
}

#[rustfmt::skip]
fn wasmer_import_get_state_root_hash(env: FunctionEnvMut<VMHooksWrapper>, pointer: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_state_root_hash(convert_mem_ptr(pointer)))
}

#[rustfmt::skip]
fn wasmer_import_get_prev_block_timestamp(env: FunctionEnvMut<VMHooksWrapper>) -> Result<i64, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_get_prev_block_round(env: FunctionEnvMut<VMHooksWrapper>) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_prev_block_round())
}

#[rustfmt::skip]
fn wasmer_import_get_prev_block_epoch(env: FunctionEnvMut<VMHooksWrapper>) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_prev_block_epoch())
}

#[rustfmt::skip]
fn wasmer_import_get_prev_block_random_seed(env: FunctionEnvMut<VMHooksWrapper>, pointer: i32) -> Result<(), VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_epoch_start_block_nonce(env: FunctionEnvMut<VMHooksWrapper>) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.epoch_start_block_nonce())
}

#[rustfmt::skip]
fn wasmer_import_epoch_start_block_round(env: FunctionEnvMut<VMHooksWrapper>) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.epoch_start_block_round())
}

#[rustfmt::skip]
fn wasmer_import_finish(env: FunctionEnvMut<VMHooksWrapper>, pointer: i32, length: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.finish(convert_mem_ptr(pointer), convert_mem_length(length)))
}

#[rustfmt::skip]
fn wasmer_import_execute_on_same_context(env: FunctionEnvMut<VMHooksWrapper>, gas_limit: i64, address_offset: i32, value_offset: i32, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_execute_on_dest_context(env: FunctionEnvMut<VMHooksWrapper>, gas_limit: i64, address_offset: i32, value_offset: i32, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_execute_read_only(env: FunctionEnvMut<VMHooksWrapper>, gas_limit: i64, address_offset: i32, function_offset: i32, function_length: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_create_contract(env: FunctionEnvMut<VMHooksWrapper>, gas_limit: i64, value_offset: i32, code_offset: i32, code_metadata_offset: i32, length: i32, result_offset: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_deploy_from_source_contract(env: FunctionEnvMut<VMHooksWrapper>, gas_limit: i64, value_offset: i32, source_contract_address_offset: i32, code_metadata_offset: i32, result_address_offset: i32, num_arguments: i32, arguments_length_offset: i32, data_offset: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_get_num_return_data(env: FunctionEnvMut<VMHooksWrapper>) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_num_return_data())
}

#[rustfmt::skip]
fn wasmer_import_get_return_data_size(env: FunctionEnvMut<VMHooksWrapper>, result_id: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_return_data_size(result_id))
}

#[rustfmt::skip]
fn wasmer_import_get_return_data(env: FunctionEnvMut<VMHooksWrapper>, result_id: i32, data_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_return_data(result_id, convert_mem_ptr(data_offset)))
}

#[rustfmt::skip]
fn wasmer_import_clean_return_data(env: FunctionEnvMut<VMHooksWrapper>) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.clean_return_data())
}

#[rustfmt::skip]
fn wasmer_import_delete_from_return_data(env: FunctionEnvMut<VMHooksWrapper>, result_id: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.delete_from_return_data(result_id))
}

#[rustfmt::skip]
fn wasmer_import_get_original_tx_hash(env: FunctionEnvMut<VMHooksWrapper>, data_offset: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_original_tx_hash(convert_mem_ptr(data_offset)))
}

#[rustfmt::skip]
fn wasmer_import_get_current_tx_hash(env: FunctionEnvMut<VMHooksWrapper>, data_offset: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_current_tx_hash(convert_mem_ptr(data_offset)))
}

#[rustfmt::skip]
fn wasmer_import_get_prev_tx_hash(env: FunctionEnvMut<VMHooksWrapper>, data_offset: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_prev_tx_hash(convert_mem_ptr(data_offset)))
}

#[rustfmt::skip]
fn wasmer_import_managed_sc_address(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_sc_address(destination_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_owner_address(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_owner_address(destination_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_caller(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_caller(destination_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_get_original_caller_addr(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_get_original_caller_addr(destination_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_get_relayer_addr(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_get_relayer_addr(destination_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_signal_error(env: FunctionEnvMut<VMHooksWrapper>, err_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_signal_error(err_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_write_log(env: FunctionEnvMut<VMHooksWrapper>, topics_handle: i32, data_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_write_log(topics_handle, data_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_get_original_tx_hash(env: FunctionEnvMut<VMHooksWrapper>, result_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_get_original_tx_hash(result_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_get_state_root_hash(env: FunctionEnvMut<VMHooksWrapper>, result_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_get_state_root_hash(result_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_get_block_random_seed(env: FunctionEnvMut<VMHooksWrapper>, result_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_get_block_random_seed(result_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_get_prev_block_random_seed(env: FunctionEnvMut<VMHooksWrapper>, result_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_get_prev_block_random_seed(result_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_get_return_data(env: FunctionEnvMut<VMHooksWrapper>, result_id: i32, result_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_get_return_data(result_id, result_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_get_multi_esdt_call_value(env: FunctionEnvMut<VMHooksWrapper>, multi_call_value_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_get_multi_esdt_call_value(multi_call_value_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_get_all_transfers_call_value(env: FunctionEnvMut<VMHooksWrapper>, transfer_call_values_list_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_get_all_transfers_call_value(transfer_call_values_list_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_get_back_transfers(env: FunctionEnvMut<VMHooksWrapper>, esdt_transfers_value_handle: i32, egld_value_handle: i32) -> Result<(), VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_get_esdt_token_data(env: FunctionEnvMut<VMHooksWrapper>, address_handle: i32, token_id_handle: i32, nonce: i64, value_handle: i32, properties_handle: i32, hash_handle: i32, name_handle: i32, attributes_handle: i32, creator_handle: i32, royalties_handle: i32, uris_handle: i32) -> Result<(), VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_get_esdt_token_type(env: FunctionEnvMut<VMHooksWrapper>, address_handle: i32, token_id_handle: i32, nonce: i64, type_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_get_esdt_token_type(address_handle, token_id_handle, nonce, type_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_async_call(env: FunctionEnvMut<VMHooksWrapper>, dest_handle: i32, value_handle: i32, function_handle: i32, arguments_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_async_call(dest_handle, value_handle, function_handle, arguments_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_create_async_call(env: FunctionEnvMut<VMHooksWrapper>, dest_handle: i32, value_handle: i32, function_handle: i32, arguments_handle: i32, success_offset: i32, success_length: i32, error_offset: i32, error_length: i32, gas: i64, extra_gas_for_callback: i64, callback_closure_handle: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_get_callback_closure(env: FunctionEnvMut<VMHooksWrapper>, callback_closure_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_get_callback_closure(callback_closure_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_upgrade_from_source_contract(env: FunctionEnvMut<VMHooksWrapper>, dest_handle: i32, gas: i64, value_handle: i32, address_handle: i32, code_metadata_handle: i32, arguments_handle: i32, result_handle: i32) -> Result<(), VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_upgrade_contract(env: FunctionEnvMut<VMHooksWrapper>, dest_handle: i32, gas: i64, value_handle: i32, code_handle: i32, code_metadata_handle: i32, arguments_handle: i32, result_handle: i32) -> Result<(), VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_delete_contract(env: FunctionEnvMut<VMHooksWrapper>, dest_handle: i32, gas_limit: i64, arguments_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_delete_contract(dest_handle, gas_limit, arguments_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_deploy_from_source_contract(env: FunctionEnvMut<VMHooksWrapper>, gas: i64, value_handle: i32, address_handle: i32, code_metadata_handle: i32, arguments_handle: i32, result_address_handle: i32, result_handle: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_create_contract(env: FunctionEnvMut<VMHooksWrapper>, gas: i64, value_handle: i32, code_handle: i32, code_metadata_handle: i32, arguments_handle: i32, result_address_handle: i32, result_handle: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_execute_read_only(env: FunctionEnvMut<VMHooksWrapper>, gas: i64, address_handle: i32, function_handle: i32, arguments_handle: i32, result_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_execute_read_only(gas, address_handle, function_handle, arguments_handle, result_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_execute_on_same_context(env: FunctionEnvMut<VMHooksWrapper>, gas: i64, address_handle: i32, value_handle: i32, function_handle: i32, arguments_handle: i32, result_handle: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_execute_on_dest_context(env: FunctionEnvMut<VMHooksWrapper>, gas: i64, address_handle: i32, value_handle: i32, function_handle: i32, arguments_handle: i32, result_handle: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_execute_on_dest_context_with_error_return(env: FunctionEnvMut<VMHooksWrapper>, gas: i64, address_handle: i32, value_handle: i32, function_handle: i32, arguments_handle: i32, result_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_execute_on_dest_context_with_error_return(gas, address_handle, value_handle, function_handle, arguments_handle, result_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_multi_transfer_esdt_nft_execute(env: FunctionEnvMut<VMHooksWrapper>, dst_handle: i32, token_transfers_handle: i32, gas_limit: i64, function_handle: i32, arguments_handle: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_multi_transfer_esdt_nft_execute_with_return(env: FunctionEnvMut<VMHooksWrapper>, dst_handle: i32, token_transfers_handle: i32, gas_limit: i64, function_handle: i32, arguments_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_multi_transfer_esdt_nft_execute_with_return(dst_handle, token_transfers_handle, gas_limit, function_handle, arguments_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_multi_transfer_esdt_nft_execute_by_user(env: FunctionEnvMut<VMHooksWrapper>, user_handle: i32, dst_handle: i32, token_transfers_handle: i32, gas_limit: i64, function_handle: i32, arguments_handle: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_transfer_value_execute(env: FunctionEnvMut<VMHooksWrapper>, dst_handle: i32, value_handle: i32, gas_limit: i64, function_handle: i32, arguments_handle: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_is_esdt_frozen(env: FunctionEnvMut<VMHooksWrapper>, address_handle: i32, token_id_handle: i32, nonce: i64) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_is_esdt_frozen(address_handle, token_id_handle, nonce))
}

#[rustfmt::skip]
fn wasmer_import_managed_is_esdt_limited_transfer(env: FunctionEnvMut<VMHooksWrapper>, token_id_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_is_esdt_limited_transfer(token_id_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_is_esdt_paused(env: FunctionEnvMut<VMHooksWrapper>, token_id_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_is_esdt_paused(token_id_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_buffer_to_hex(env: FunctionEnvMut<VMHooksWrapper>, source_handle: i32, dest_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_buffer_to_hex(source_handle, dest_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_get_code_metadata(env: FunctionEnvMut<VMHooksWrapper>, address_handle: i32, response_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_get_code_metadata(address_handle, response_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_get_code_hash(env: FunctionEnvMut<VMHooksWrapper>, address_handle: i32, code_hash_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_get_code_hash(address_handle, code_hash_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_is_builtin_function(env: FunctionEnvMut<VMHooksWrapper>, function_name_handle: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_big_float_new_from_frac(env: FunctionEnvMut<VMHooksWrapper>, numerator: i64, denominator: i64) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_new_from_frac(numerator, denominator))
}

#[rustfmt::skip]
fn wasmer_import_big_float_new_from_sci(env: FunctionEnvMut<VMHooksWrapper>, significand: i64, exponent: i64) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_new_from_sci(significand, exponent))
}

#[rustfmt::skip]
fn wasmer_import_big_float_add(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op1_handle: i32, op2_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_add(destination_handle, op1_handle, op2_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_float_sub(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op1_handle: i32, op2_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_sub(destination_handle, op1_handle, op2_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_float_mul(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op1_handle: i32, op2_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_mul(destination_handle, op1_handle, op2_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_float_div(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op1_handle: i32, op2_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_div(destination_handle, op1_handle, op2_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_float_neg(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_neg(destination_handle, op_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_float_clone(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_clone(destination_handle, op_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_float_cmp(env: FunctionEnvMut<VMHooksWrapper>, op1_handle: i32, op2_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_cmp(op1_handle, op2_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_float_abs(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_abs(destination_handle, op_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_float_sign(env: FunctionEnvMut<VMHooksWrapper>, op_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_sign(op_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_float_sqrt(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_sqrt(destination_handle, op_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_float_pow(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op_handle: i32, exponent: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_pow(destination_handle, op_handle, exponent))
}

#[rustfmt::skip]
fn wasmer_import_big_float_floor(env: FunctionEnvMut<VMHooksWrapper>, dest_big_int_handle: i32, op_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_floor(dest_big_int_handle, op_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_float_ceil(env: FunctionEnvMut<VMHooksWrapper>, dest_big_int_handle: i32, op_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_ceil(dest_big_int_handle, op_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_float_truncate(env: FunctionEnvMut<VMHooksWrapper>, dest_big_int_handle: i32, op_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_truncate(dest_big_int_handle, op_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_float_set_int64(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, value: i64) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_set_int64(destination_handle, value))
}

#[rustfmt::skip]
fn wasmer_import_big_float_is_int(env: FunctionEnvMut<VMHooksWrapper>, op_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_is_int(op_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_float_set_big_int(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, big_int_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_set_big_int(destination_handle, big_int_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_float_get_const_pi(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_get_const_pi(destination_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_float_get_const_e(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_float_get_const_e(destination_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_get_unsigned_argument(env: FunctionEnvMut<VMHooksWrapper>, id: i32, destination_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_get_unsigned_argument(id, destination_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_get_signed_argument(env: FunctionEnvMut<VMHooksWrapper>, id: i32, destination_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_get_signed_argument(id, destination_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_storage_store_unsigned(env: FunctionEnvMut<VMHooksWrapper>, key_offset: i32, key_length: i32, source_handle: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_big_int_storage_load_unsigned(env: FunctionEnvMut<VMHooksWrapper>, key_offset: i32, key_length: i32, destination_handle: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_big_int_get_call_value(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_get_call_value(destination_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_get_esdt_call_value(env: FunctionEnvMut<VMHooksWrapper>, destination: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_get_esdt_call_value(destination))
}

#[rustfmt::skip]
fn wasmer_import_big_int_get_esdt_call_value_by_index(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, index: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_get_esdt_call_value_by_index(destination_handle, index))
}

#[rustfmt::skip]
fn wasmer_import_big_int_get_external_balance(env: FunctionEnvMut<VMHooksWrapper>, address_offset: i32, result: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_get_external_balance(convert_mem_ptr(address_offset), result))
}

#[rustfmt::skip]
fn wasmer_import_big_int_get_esdt_external_balance(env: FunctionEnvMut<VMHooksWrapper>, address_offset: i32, token_id_offset: i32, token_id_len: i32, nonce: i64, result_handle: i32) -> Result<(), VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_big_int_new(env: FunctionEnvMut<VMHooksWrapper>, small_value: i64) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_new(small_value))
}

#[rustfmt::skip]
fn wasmer_import_big_int_unsigned_byte_length(env: FunctionEnvMut<VMHooksWrapper>, reference_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_unsigned_byte_length(reference_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_signed_byte_length(env: FunctionEnvMut<VMHooksWrapper>, reference_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_signed_byte_length(reference_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_get_unsigned_bytes(env: FunctionEnvMut<VMHooksWrapper>, reference_handle: i32, byte_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_get_unsigned_bytes(reference_handle, convert_mem_ptr(byte_offset)))
}

#[rustfmt::skip]
fn wasmer_import_big_int_get_signed_bytes(env: FunctionEnvMut<VMHooksWrapper>, reference_handle: i32, byte_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_get_signed_bytes(reference_handle, convert_mem_ptr(byte_offset)))
}

#[rustfmt::skip]
fn wasmer_import_big_int_set_unsigned_bytes(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, byte_offset: i32, byte_length: i32) -> Result<(), VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_big_int_set_signed_bytes(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, byte_offset: i32, byte_length: i32) -> Result<(), VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_big_int_is_int64(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_is_int64(destination_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_get_int64(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_get_int64(destination_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_set_int64(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, value: i64) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_set_int64(destination_handle, value))
}

#[rustfmt::skip]
fn wasmer_import_big_int_add(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op1_handle: i32, op2_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_add(destination_handle, op1_handle, op2_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_sub(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op1_handle: i32, op2_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_sub(destination_handle, op1_handle, op2_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_mul(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op1_handle: i32, op2_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_mul(destination_handle, op1_handle, op2_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_tdiv(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op1_handle: i32, op2_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_tdiv(destination_handle, op1_handle, op2_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_tmod(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op1_handle: i32, op2_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_tmod(destination_handle, op1_handle, op2_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_ediv(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op1_handle: i32, op2_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_ediv(destination_handle, op1_handle, op2_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_emod(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op1_handle: i32, op2_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_emod(destination_handle, op1_handle, op2_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_sqrt(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_sqrt(destination_handle, op_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_pow(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op1_handle: i32, op2_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_pow(destination_handle, op1_handle, op2_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_log2(env: FunctionEnvMut<VMHooksWrapper>, op1_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_log2(op1_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_abs(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_abs(destination_handle, op_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_neg(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_neg(destination_handle, op_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_sign(env: FunctionEnvMut<VMHooksWrapper>, op_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_sign(op_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_cmp(env: FunctionEnvMut<VMHooksWrapper>, op1_handle: i32, op2_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_cmp(op1_handle, op2_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_not(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_not(destination_handle, op_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_and(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op1_handle: i32, op2_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_and(destination_handle, op1_handle, op2_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_or(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op1_handle: i32, op2_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_or(destination_handle, op1_handle, op2_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_xor(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op1_handle: i32, op2_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_xor(destination_handle, op1_handle, op2_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_shr(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op_handle: i32, bits: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_shr(destination_handle, op_handle, bits))
}

#[rustfmt::skip]
fn wasmer_import_big_int_shl(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, op_handle: i32, bits: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_shl(destination_handle, op_handle, bits))
}

#[rustfmt::skip]
fn wasmer_import_big_int_finish_unsigned(env: FunctionEnvMut<VMHooksWrapper>, reference_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_finish_unsigned(reference_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_finish_signed(env: FunctionEnvMut<VMHooksWrapper>, reference_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_finish_signed(reference_handle))
}

#[rustfmt::skip]
fn wasmer_import_big_int_to_string(env: FunctionEnvMut<VMHooksWrapper>, big_int_handle: i32, destination_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.big_int_to_string(big_int_handle, destination_handle))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_new(env: FunctionEnvMut<VMHooksWrapper>) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_new())
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_new_from_bytes(env: FunctionEnvMut<VMHooksWrapper>, data_offset: i32, data_length: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_new_from_bytes(convert_mem_ptr(data_offset), convert_mem_length(data_length)))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_get_length(env: FunctionEnvMut<VMHooksWrapper>, m_buffer_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_get_length(m_buffer_handle))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_get_bytes(env: FunctionEnvMut<VMHooksWrapper>, m_buffer_handle: i32, result_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_get_bytes(m_buffer_handle, convert_mem_ptr(result_offset)))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_get_byte_slice(env: FunctionEnvMut<VMHooksWrapper>, source_handle: i32, starting_position: i32, slice_length: i32, result_offset: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_mbuffer_copy_byte_slice(env: FunctionEnvMut<VMHooksWrapper>, source_handle: i32, starting_position: i32, slice_length: i32, destination_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_copy_byte_slice(source_handle, starting_position, slice_length, destination_handle))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_eq(env: FunctionEnvMut<VMHooksWrapper>, m_buffer_handle1: i32, m_buffer_handle2: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_eq(m_buffer_handle1, m_buffer_handle2))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_set_bytes(env: FunctionEnvMut<VMHooksWrapper>, m_buffer_handle: i32, data_offset: i32, data_length: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_set_bytes(m_buffer_handle, convert_mem_ptr(data_offset), convert_mem_length(data_length)))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_set_byte_slice(env: FunctionEnvMut<VMHooksWrapper>, m_buffer_handle: i32, starting_position: i32, data_length: i32, data_offset: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_mbuffer_append(env: FunctionEnvMut<VMHooksWrapper>, accumulator_handle: i32, data_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_append(accumulator_handle, data_handle))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_append_bytes(env: FunctionEnvMut<VMHooksWrapper>, accumulator_handle: i32, data_offset: i32, data_length: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_mbuffer_to_big_int_unsigned(env: FunctionEnvMut<VMHooksWrapper>, m_buffer_handle: i32, big_int_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_to_big_int_unsigned(m_buffer_handle, big_int_handle))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_to_big_int_signed(env: FunctionEnvMut<VMHooksWrapper>, m_buffer_handle: i32, big_int_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_to_big_int_signed(m_buffer_handle, big_int_handle))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_from_big_int_unsigned(env: FunctionEnvMut<VMHooksWrapper>, m_buffer_handle: i32, big_int_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_from_big_int_unsigned(m_buffer_handle, big_int_handle))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_from_big_int_signed(env: FunctionEnvMut<VMHooksWrapper>, m_buffer_handle: i32, big_int_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_from_big_int_signed(m_buffer_handle, big_int_handle))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_to_small_int_unsigned(env: FunctionEnvMut<VMHooksWrapper>, m_buffer_handle: i32) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_to_small_int_unsigned(m_buffer_handle))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_to_small_int_signed(env: FunctionEnvMut<VMHooksWrapper>, m_buffer_handle: i32) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_to_small_int_signed(m_buffer_handle))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_from_small_int_unsigned(env: FunctionEnvMut<VMHooksWrapper>, m_buffer_handle: i32, value: i64) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_from_small_int_unsigned(m_buffer_handle, value))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_from_small_int_signed(env: FunctionEnvMut<VMHooksWrapper>, m_buffer_handle: i32, value: i64) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_from_small_int_signed(m_buffer_handle, value))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_to_big_float(env: FunctionEnvMut<VMHooksWrapper>, m_buffer_handle: i32, big_float_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_to_big_float(m_buffer_handle, big_float_handle))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_from_big_float(env: FunctionEnvMut<VMHooksWrapper>, m_buffer_handle: i32, big_float_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_from_big_float(m_buffer_handle, big_float_handle))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_storage_store(env: FunctionEnvMut<VMHooksWrapper>, key_handle: i32, source_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_storage_store(key_handle, source_handle))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_storage_load(env: FunctionEnvMut<VMHooksWrapper>, key_handle: i32, destination_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_storage_load(key_handle, destination_handle))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_storage_load_from_address(env: FunctionEnvMut<VMHooksWrapper>, address_handle: i32, key_handle: i32, destination_handle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_storage_load_from_address(address_handle, key_handle, destination_handle))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_get_argument(env: FunctionEnvMut<VMHooksWrapper>, id: i32, destination_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_get_argument(id, destination_handle))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_finish(env: FunctionEnvMut<VMHooksWrapper>, source_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_finish(source_handle))
}

#[rustfmt::skip]
fn wasmer_import_mbuffer_set_random(env: FunctionEnvMut<VMHooksWrapper>, destination_handle: i32, length: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.mbuffer_set_random(destination_handle, length))
}

#[rustfmt::skip]
fn wasmer_import_managed_map_new(env: FunctionEnvMut<VMHooksWrapper>) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_map_new())
}

#[rustfmt::skip]
fn wasmer_import_managed_map_put(env: FunctionEnvMut<VMHooksWrapper>, m_map_handle: i32, key_handle: i32, value_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_map_put(m_map_handle, key_handle, value_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_map_get(env: FunctionEnvMut<VMHooksWrapper>, m_map_handle: i32, key_handle: i32, out_value_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_map_get(m_map_handle, key_handle, out_value_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_map_remove(env: FunctionEnvMut<VMHooksWrapper>, m_map_handle: i32, key_handle: i32, out_value_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_map_remove(m_map_handle, key_handle, out_value_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_map_contains(env: FunctionEnvMut<VMHooksWrapper>, m_map_handle: i32, key_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_map_contains(m_map_handle, key_handle))
}

#[rustfmt::skip]
fn wasmer_import_small_int_get_unsigned_argument(env: FunctionEnvMut<VMHooksWrapper>, id: i32) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.small_int_get_unsigned_argument(id))
}

#[rustfmt::skip]
fn wasmer_import_small_int_get_signed_argument(env: FunctionEnvMut<VMHooksWrapper>, id: i32) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.small_int_get_signed_argument(id))
}

#[rustfmt::skip]
fn wasmer_import_small_int_finish_unsigned(env: FunctionEnvMut<VMHooksWrapper>, value: i64) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.small_int_finish_unsigned(value))
}

#[rustfmt::skip]
fn wasmer_import_small_int_finish_signed(env: FunctionEnvMut<VMHooksWrapper>, value: i64) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.small_int_finish_signed(value))
}

#[rustfmt::skip]
fn wasmer_import_small_int_storage_store_unsigned(env: FunctionEnvMut<VMHooksWrapper>, key_offset: i32, key_length: i32, value: i64) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.small_int_storage_store_unsigned(convert_mem_ptr(key_offset), convert_mem_length(key_length), value))
}

#[rustfmt::skip]
fn wasmer_import_small_int_storage_store_signed(env: FunctionEnvMut<VMHooksWrapper>, key_offset: i32, key_length: i32, value: i64) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.small_int_storage_store_signed(convert_mem_ptr(key_offset), convert_mem_length(key_length), value))
}

#[rustfmt::skip]
fn wasmer_import_small_int_storage_load_unsigned(env: FunctionEnvMut<VMHooksWrapper>, key_offset: i32, key_length: i32) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.small_int_storage_load_unsigned(convert_mem_ptr(key_offset), convert_mem_length(key_length)))
}

#[rustfmt::skip]
fn wasmer_import_small_int_storage_load_signed(env: FunctionEnvMut<VMHooksWrapper>, key_offset: i32, key_length: i32) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.small_int_storage_load_signed(convert_mem_ptr(key_offset), convert_mem_length(key_length)))
}

#[rustfmt::skip]
fn wasmer_import_int64get_argument(env: FunctionEnvMut<VMHooksWrapper>, id: i32) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.int64get_argument(id))
}

#[rustfmt::skip]
fn wasmer_import_int64finish(env: FunctionEnvMut<VMHooksWrapper>, value: i64) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.int64finish(value))
}

#[rustfmt::skip]
fn wasmer_import_int64storage_store(env: FunctionEnvMut<VMHooksWrapper>, key_offset: i32, key_length: i32, value: i64) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.int64storage_store(convert_mem_ptr(key_offset), convert_mem_length(key_length), value))
}

#[rustfmt::skip]
fn wasmer_import_int64storage_load(env: FunctionEnvMut<VMHooksWrapper>, key_offset: i32, key_length: i32) -> Result<i64, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.int64storage_load(convert_mem_ptr(key_offset), convert_mem_length(key_length)))
}

#[rustfmt::skip]
fn wasmer_import_sha256(env: FunctionEnvMut<VMHooksWrapper>, data_offset: i32, length: i32, result_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.sha256(convert_mem_ptr(data_offset), convert_mem_length(length), convert_mem_ptr(result_offset)))
}

#[rustfmt::skip]
fn wasmer_import_managed_sha256(env: FunctionEnvMut<VMHooksWrapper>, input_handle: i32, output_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_sha256(input_handle, output_handle))
}

#[rustfmt::skip]
fn wasmer_import_keccak256(env: FunctionEnvMut<VMHooksWrapper>, data_offset: i32, length: i32, result_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.keccak256(convert_mem_ptr(data_offset), convert_mem_length(length), convert_mem_ptr(result_offset)))
}

#[rustfmt::skip]
fn wasmer_import_managed_keccak256(env: FunctionEnvMut<VMHooksWrapper>, input_handle: i32, output_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_keccak256(input_handle, output_handle))
}

#[rustfmt::skip]
fn wasmer_import_ripemd160(env: FunctionEnvMut<VMHooksWrapper>, data_offset: i32, length: i32, result_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.ripemd160(convert_mem_ptr(data_offset), convert_mem_length(length), convert_mem_ptr(result_offset)))
}

#[rustfmt::skip]
fn wasmer_import_managed_ripemd160(env: FunctionEnvMut<VMHooksWrapper>, input_handle: i32, output_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_ripemd160(input_handle, output_handle))
}

#[rustfmt::skip]
fn wasmer_import_verify_bls(env: FunctionEnvMut<VMHooksWrapper>, key_offset: i32, message_offset: i32, message_length: i32, sig_offset: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_verify_bls(env: FunctionEnvMut<VMHooksWrapper>, key_handle: i32, message_handle: i32, sig_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_verify_bls(key_handle, message_handle, sig_handle))
}

#[rustfmt::skip]
fn wasmer_import_verify_ed25519(env: FunctionEnvMut<VMHooksWrapper>, key_offset: i32, message_offset: i32, message_length: i32, sig_offset: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_verify_ed25519(env: FunctionEnvMut<VMHooksWrapper>, key_handle: i32, message_handle: i32, sig_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_verify_ed25519(key_handle, message_handle, sig_handle))
}

#[rustfmt::skip]
fn wasmer_import_verify_custom_secp256k1(env: FunctionEnvMut<VMHooksWrapper>, key_offset: i32, key_length: i32, message_offset: i32, message_length: i32, sig_offset: i32, hash_type: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_verify_custom_secp256k1(env: FunctionEnvMut<VMHooksWrapper>, key_handle: i32, message_handle: i32, sig_handle: i32, hash_type: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_verify_custom_secp256k1(key_handle, message_handle, sig_handle, hash_type))
}

#[rustfmt::skip]
fn wasmer_import_verify_secp256k1(env: FunctionEnvMut<VMHooksWrapper>, key_offset: i32, key_length: i32, message_offset: i32, message_length: i32, sig_offset: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_verify_secp256k1(env: FunctionEnvMut<VMHooksWrapper>, key_handle: i32, message_handle: i32, sig_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_verify_secp256k1(key_handle, message_handle, sig_handle))
}

#[rustfmt::skip]
fn wasmer_import_encode_secp256k1_der_signature(env: FunctionEnvMut<VMHooksWrapper>, r_offset: i32, r_length: i32, s_offset: i32, s_length: i32, sig_offset: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_encode_secp256k1_der_signature(env: FunctionEnvMut<VMHooksWrapper>, r_handle: i32, s_handle: i32, sig_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_encode_secp256k1_der_signature(r_handle, s_handle, sig_handle))
}

#[rustfmt::skip]
fn wasmer_import_add_ec(env: FunctionEnvMut<VMHooksWrapper>, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, fst_point_xhandle: i32, fst_point_yhandle: i32, snd_point_xhandle: i32, snd_point_yhandle: i32) -> Result<(), VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_double_ec(env: FunctionEnvMut<VMHooksWrapper>, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, point_xhandle: i32, point_yhandle: i32) -> Result<(), VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.double_ec(x_result_handle, y_result_handle, ec_handle, point_xhandle, point_yhandle))
}

#[rustfmt::skip]
fn wasmer_import_is_on_curve_ec(env: FunctionEnvMut<VMHooksWrapper>, ec_handle: i32, point_xhandle: i32, point_yhandle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.is_on_curve_ec(ec_handle, point_xhandle, point_yhandle))
}

#[rustfmt::skip]
fn wasmer_import_scalar_base_mult_ec(env: FunctionEnvMut<VMHooksWrapper>, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, data_offset: i32, length: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_scalar_base_mult_ec(env: FunctionEnvMut<VMHooksWrapper>, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, data_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_scalar_base_mult_ec(x_result_handle, y_result_handle, ec_handle, data_handle))
}

#[rustfmt::skip]
fn wasmer_import_scalar_mult_ec(env: FunctionEnvMut<VMHooksWrapper>, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, point_xhandle: i32, point_yhandle: i32, data_offset: i32, length: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_scalar_mult_ec(env: FunctionEnvMut<VMHooksWrapper>, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, point_xhandle: i32, point_yhandle: i32, data_handle: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_marshal_ec(env: FunctionEnvMut<VMHooksWrapper>, x_pair_handle: i32, y_pair_handle: i32, ec_handle: i32, result_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.marshal_ec(x_pair_handle, y_pair_handle, ec_handle, convert_mem_ptr(result_offset)))
}

#[rustfmt::skip]
fn wasmer_import_managed_marshal_ec(env: FunctionEnvMut<VMHooksWrapper>, x_pair_handle: i32, y_pair_handle: i32, ec_handle: i32, result_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_marshal_ec(x_pair_handle, y_pair_handle, ec_handle, result_handle))
}

#[rustfmt::skip]
fn wasmer_import_marshal_compressed_ec(env: FunctionEnvMut<VMHooksWrapper>, x_pair_handle: i32, y_pair_handle: i32, ec_handle: i32, result_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.marshal_compressed_ec(x_pair_handle, y_pair_handle, ec_handle, convert_mem_ptr(result_offset)))
}

#[rustfmt::skip]
fn wasmer_import_managed_marshal_compressed_ec(env: FunctionEnvMut<VMHooksWrapper>, x_pair_handle: i32, y_pair_handle: i32, ec_handle: i32, result_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_marshal_compressed_ec(x_pair_handle, y_pair_handle, ec_handle, result_handle))
}

#[rustfmt::skip]
fn wasmer_import_unmarshal_ec(env: FunctionEnvMut<VMHooksWrapper>, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, data_offset: i32, length: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_unmarshal_ec(env: FunctionEnvMut<VMHooksWrapper>, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, data_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_unmarshal_ec(x_result_handle, y_result_handle, ec_handle, data_handle))
}

#[rustfmt::skip]
fn wasmer_import_unmarshal_compressed_ec(env: FunctionEnvMut<VMHooksWrapper>, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, data_offset: i32, length: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_unmarshal_compressed_ec(env: FunctionEnvMut<VMHooksWrapper>, x_result_handle: i32, y_result_handle: i32, ec_handle: i32, data_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_unmarshal_compressed_ec(x_result_handle, y_result_handle, ec_handle, data_handle))
}

#[rustfmt::skip]
fn wasmer_import_generate_key_ec(env: FunctionEnvMut<VMHooksWrapper>, x_pub_key_handle: i32, y_pub_key_handle: i32, ec_handle: i32, result_offset: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.generate_key_ec(x_pub_key_handle, y_pub_key_handle, ec_handle, convert_mem_ptr(result_offset)))
}

#[rustfmt::skip]
fn wasmer_import_managed_generate_key_ec(env: FunctionEnvMut<VMHooksWrapper>, x_pub_key_handle: i32, y_pub_key_handle: i32, ec_handle: i32, result_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_generate_key_ec(x_pub_key_handle, y_pub_key_handle, ec_handle, result_handle))
}

#[rustfmt::skip]
fn wasmer_import_create_ec(env: FunctionEnvMut<VMHooksWrapper>, data_offset: i32, data_length: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.create_ec(convert_mem_ptr(data_offset), convert_mem_length(data_length)))
}

#[rustfmt::skip]
fn wasmer_import_managed_create_ec(env: FunctionEnvMut<VMHooksWrapper>, data_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_create_ec(data_handle))
}

#[rustfmt::skip]
fn wasmer_import_get_curve_length_ec(env: FunctionEnvMut<VMHooksWrapper>, ec_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_curve_length_ec(ec_handle))
}

#[rustfmt::skip]
fn wasmer_import_get_priv_key_byte_length_ec(env: FunctionEnvMut<VMHooksWrapper>, ec_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.get_priv_key_byte_length_ec(ec_handle))
}

#[rustfmt::skip]
fn wasmer_import_elliptic_curve_get_values(env: FunctionEnvMut<VMHooksWrapper>, ec_handle: i32, field_order_handle: i32, base_point_order_handle: i32, eq_constant_handle: i32, x_base_point_handle: i32, y_base_point_handle: i32) -> Result<i32, VMHooksEarlyExit> {
...
#[rustfmt::skip]
fn wasmer_import_managed_verify_secp256r1(env: FunctionEnvMut<VMHooksWrapper>, key_handle: i32, message_handle: i32, sig_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_verify_secp256r1(key_handle, message_handle, sig_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_verify_blssignature_share(env: FunctionEnvMut<VMHooksWrapper>, key_handle: i32, message_handle: i32, sig_handle: i32) -> Result<i32, VMHooksEarlyExit> {
    with_vm_hooks(env, |vh| vh.managed_verify_blssignature_share(key_handle, message_handle, sig_handle))
}

#[rustfmt::skip]
fn wasmer_import_managed_verify_blsaggregated_signature(env: FunctionEnvMut<VMHooksWrapper>, key_handle: i32, message_handle: i32, sig_handle: i32) -> Result<i32, VMHooksEarlyExit> {
...
pub fn generate_import_object(store: &mut Store, vh_wrapper: VMHooksWrapper) -> Imports {
    ...
    imports! {
        "env" => {
            ...
            "managedExecuteOnDestContextWithErrorReturn" => Function::new_typed_with_env(store, &function_env, wasmer_import_managed_execute_on_dest_context_with_error_return),
            ...
            "managedMultiTransferESDTNFTExecuteWithReturn" => Function::new_typed_with_env(store, &function_env, wasmer_import_managed_multi_transfer_esdt_nft_execute_with_return),
            ...
            "mBufferToSmallIntUnsigned" => Function::new_typed_with_env(store, &function_env, wasmer_import_mbuffer_to_small_int_unsigned),
            "mBufferToSmallIntSigned" => Function::new_typed_with_env(store, &function_env, wasmer_import_mbuffer_to_small_int_signed),
            "mBufferFromSmallIntUnsigned" => Function::new_typed_with_env(store, &function_env, wasmer_import_mbuffer_from_small_int_unsigned),
            "mBufferFromSmallIntSigned" => Function::new_typed_with_env(store, &function_env, wasmer_import_mbuffer_from_small_int_signed),
