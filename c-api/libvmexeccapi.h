 ...
 */
typedef struct vm_exec_instance_t {

} vm_exec_instance_t;

typedef struct vm_exec_executor_t {

} vm_exec_executor_t;

typedef struct vm_exec_vm_hook_c_func_pointers {
  ...
  int32_t (*managed_drwa_native_governance_query_func_ptr)(void *context,
                                                           int32_t query_type,
                                                           int32_t key_handle,
                                                           int32_t dest_handle);
 ...
 * C API function, works with raw object pointers.
 */
uint64_t vm_exec_instance_get_breakpoint_value(const struct vm_exec_instance_t *instance_ptr);
 ...
 * C API function, works with raw object pointers.
 */
void vm_exec_executor_destroy(struct vm_exec_executor_t *executor_ptr);
 ...
 * C API function, works with raw object pointers.
 */
enum vm_exec_result_t vm_check_signatures(struct vm_exec_instance_t *instance_ptr);
 ...
 * C API function, works with raw object pointers.
 */
int vm_exported_function_names_length(struct vm_exec_instance_t *instance_ptr);
 ...
 * C API function, works with raw object pointers.
 */
void vm_exec_instance_destroy(struct vm_exec_instance_t *instance_ptr);
 ...
 * Sets the log level.
 */
enum vm_exec_result_t vm_exec_set_log_level(uint64_t value);
 ...
 * C API function, works with raw object pointers.
 */
uint64_t vm_exec_instance_memory_data_length(struct vm_exec_instance_t *instance_ptr);
 ...
 * C API function, works with raw object pointers.
 */
uint8_t *vm_exec_instance_memory_data(struct vm_exec_instance_t *instance_ptr);
 ...
 * C API function, works with raw object pointers.
 */
uint64_t vm_exec_instance_get_points_used(const struct vm_exec_instance_t *instance_ptr);
