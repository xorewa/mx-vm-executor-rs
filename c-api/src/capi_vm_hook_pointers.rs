...
pub struct vm_exec_vm_hook_c_func_pointers {
    ...
    pub get_block_timestamp_ms_func_ptr: extern "C" fn(context: *mut c_void) -> i64,
    ...
    pub get_prev_block_timestamp_ms_func_ptr: extern "C" fn(context: *mut c_void) -> i64,
    ...
    pub managed_get_all_transfers_call_value_func_ptr: extern "C" fn(context: *mut c_void, transfer_call_values_list_handle: i32),
    ...
    pub managed_execute_on_dest_context_with_error_return_func_ptr: extern "C" fn(context: *mut c_void, gas: i64, address_handle: i32, value_handle: i32, function_handle: i32, arguments_handle: i32, result_handle: i32) -> i32,
    ...
    pub managed_multi_transfer_esdt_nft_execute_with_return_func_ptr: extern "C" fn(context: *mut c_void, dst_handle: i32, token_transfers_handle: i32, gas_limit: i64, function_handle: i32, arguments_handle: i32) -> i32,
